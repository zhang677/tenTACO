#ifndef MTTKRP5_CPU_TACO_H
#define MTTKRP5_CPU_TACO_H

#include "ds.h"
#include "timers.h"

void mttkrp5_cpu_taco(taco_tensor_t *A, taco_tensor_t *B, taco_tensor_t *C, taco_tensor_t *D, taco_tensor_t *E, taco_tensor_t *F) {
TIME_COLD(
